...
import wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "山东";
    private String strCity = "淄博";
    private String strArea = "临淄区";
...
//          dismiss();
    ...
    public void initCitys(String[] citys) {
        if (citys != null) {
            ...
            String[] city = mCitisDatasMap.get("山东");
            arrCitys.clear();
    ...
    public void initAreas(String[] areas) {
        if (areas != null) {
            ...
            String[] area = mAreaDatasMap.get("淄博");
            arrAreas.clear();
