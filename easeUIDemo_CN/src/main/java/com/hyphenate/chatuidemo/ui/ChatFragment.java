...
//            startActivity(new Intent(getActivity(), VoiceCallActivity.class).putExtra("username", DemoApplication.currentUserNick)
...
//            startActivity(new Intent(getActivity(), VideoCallActivity.class).putExtra("username", DemoApplication.currentUserNick)
//                    .putExtra("isComingCall", false));
